...
public class ConsumerApplication {
    public static void main(String[] args) {
        ...
        exchangeProperties.put("x-dead-letter-exchange", "roberto.order.failure");
        rabbitAdmin.declareQueue(new Queue("roberto.order.add", true, false, false, exchangeProperties));
        // 声明AE 类型为Fanout
